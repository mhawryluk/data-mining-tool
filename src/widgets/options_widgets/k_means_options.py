...
class KMeansOptions(Options):
    def __init__(self):
        ...
        self.layout.addRow(QLabelWithTooltip('Type of initial solution:'), self.start_type_box)
        ...
        self.layout.addRow(QLabelWithTooltip("Exponent in metrics:"), self.metrics_spinbox)
        ...
        self.layout.addRow(QLabelWithTooltip("Number of repetitions:"), self.num_repeat_spinbox)
