...
class ExtraTreesOptions(AlgorithmOptions):
    def __init__(self):
        ...
        self.layout.addRow(QLabel("Number of features to sample:"), self.features_number_spinbox)
        ...
        self.layout.addRow(QLabel("Minimum number of samples in child:"), self.min_child_number_spinbox)
